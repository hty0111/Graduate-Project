...
exp="agents_${num_agents}_obs_${num_obstacles}_threads_${n_rollout_threads}_steps_${num_steps}"
...
do
    ...
    --n_training_threads 1 --n_rollout_threads ${n_rollout_threads} -num_mini_batch 1 --episode_length 25 --num_env_steps ${num_steps} \
