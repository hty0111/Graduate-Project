...
class SharedReplayBuffer(object):
    ...
    :param state_space: (gym.Space) centralized observation space of agents.
    :param act_space: (gym.Space) action space for agents.
    """

    def __init__(self, args, num_agents, obs_space, state_space, act_space):
    ...
    def insert(self, state, obs, rnn_states_actor, rnn_states_critic, actions, action_log_probs,
               value_preds, rewards, masks, bad_masks=None, active_masks=None, available_actions=None):
        """
        Insert data into the buffer.
        :param state: (argparse.Namespace) arguments containing relevant model, policy, and env information.
    ...
    def chooseinsert(self, state, obs, rnn_states, rnn_states_critic, actions, action_log_probs,
                     value_preds, rewards, masks, bad_masks=None, active_masks=None, available_actions=None):
        """
    ...
    def after_update(self):
        ...
        self.observations[0] = self.observations[-1].copy()
    ...
    def feed_forward_generator(self, advantages, num_mini_batch=None, mini_batch_size=None):
        ...
        obs = self.observations[:-1].reshape(-1, *self.observations.shape[3:])
    ...
    def naive_recurrent_generator(self, advantages, num_mini_batch):
        ...
        obs = self.observations.reshape(-1, batch_size, *self.observations.shape[3:])
        ...
        for start_ind in range(0, batch_size, num_envs_per_batch):
            ...
            for offset in range(num_envs_per_batch):
                ...
                share_obs_batch.append(state[:-1, ind])
    ...
    def recurrent_generator(self, advantages, num_mini_batch, data_chunk_length):
        ...
        if len(self.state.shape) > 4:
            ...
            obs = self.observations[:-1].transpose(1, 2, 0, 3, 4, 5).reshape(-1, *self.observations.shape[3:])
        else:
            state = _cast(self.state[:-1])
            obs = _cast(self.observations[:-1])
        ...
        for indices in sampler:
            ...
            for index in indices:
                ...
                share_obs_batch.append(state[ind:ind + data_chunk_length])
